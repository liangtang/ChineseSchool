...
namespace ChineseSchool.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ResendConfirmationEmail(string userid)
        {
            ...
            await UserManager.SendEmailAsync(userid, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a><br />Or copy the address below and open in browser:<br/>" + callbackUrl);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData["Message"] = "This email already registed, please reset password";
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a><br />Or copy the address below and open in browser:<br/>" + callbackUrl);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    TempData["Message"] = "This email has not been registered, please register";
                ...
                await UserManager.SendEmailAsync(user.Id, "Reset Password", "Please reset your password by clicking <a href=\"" + callbackUrl + "\">here</a><br />Or copy the address below and open in browser:<br/>" + callbackUrl);
